        ...
        <div class="block-offer-search__wrapper">
            <div class="block-offer-search__left">
                ...
                <details class="block-offer-search__keyword-search fade-in">
                    ...
                    <div class="block-offer-search__keyword-search-wrapper">
                        <input type="text" class="block-offer-search__keyword-search-input" placeholder="<?php _e( 'Wpisz słowo kluczowe', 'humanitas' ); ?>">
                        <button class="block-offer-search__keyword-search-button button button-yellow" aria-label="<?php echo __( 'Search Button', 'humanitas' ); ?>">
                            <?php echo get_image( 'search-icon' ); ?>
                        </button>
                    </div>
                </details>
