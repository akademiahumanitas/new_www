...
class Nav_Walker extends \Walker_Nav_Menu {
  ...
  public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
      ...
      $item_output .= '<a' . $attributes . '>';
		...
		$fallback_output .= '<li class="menu-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'humanitas' ) . '">' . esc_html__( 'Add a menu', 'humanitas' ) . '</a></li>';
		$fallback_output .= '</ul>';
