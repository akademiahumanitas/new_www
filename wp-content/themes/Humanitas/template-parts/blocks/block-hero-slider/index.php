...
<section class="block-hero-slider fade-in" id="<?php echo $block_ID; ?>">
    <div class="container">
        <div class="block-hero-slider__slider-wrapper">
            ...
            <div class="block-hero-slider__controls">
                <button class="block-hero-slider__controls-button js-play-pause-button autoplay">
                    <?php echo get_image( 'play' ); ?>
                    <?php echo get_image( 'pause' ); ?>
                </button>
            </div>
        </div>
    ...
    <div class="block-hero-slider__triangle">
        <?php echo get_image( 'triangle-bottom-left' ); ?>
    </div>
</section>
