...
if ( ! class_exists( 'WP_Webhooks_Pro' ) ) :
	...
	final class WP_Webhooks_Pro {
		...
		/**
		 * WPWHPRO WP Lists table Object.
		 *
		 * @var object|WP_Webhooks_Pro_WP_List_Table_Wrapper
		 * @since 6.1.0
		 */
		public $lists;
		...
		/**
		 * WPWHPRO Action Scheduler Object.
		 *
		 * @var object|WP_Webhooks_Pro_Scheduler
		 * @since 6.0
		 */
		public $scheduler;
		...
		/**
		 * WPWHPRO Migrate Object.
		 *
		 * @var object|WP_Webhooks_Pro_Migrate
		 * @since 6.0
		 */
		public $migrate;
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'wp-webhooks' ), '1.0.0' );
		}
		...
		public static function instance() {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof WP_Webhooks_Pro ) ) {
				...
				self::$instance->lists          = new WP_Webhooks_Pro_WP_List_Table_Wrapper();
				self::$instance->async          = new WP_Webhooks_Pro_Async();
				self::$instance->scheduler      = new WP_Webhooks_Pro_Scheduler();
				...
				self::$instance->migrate      	= new WP_Webhooks_Pro_Migrate();
		...
		private function includes() {
			...
			if( file_exists( WPWHPRO_PLUGIN_DIR . 'core/includes/libraries/action-scheduler/action-scheduler.php' ) ){
				require_once WPWHPRO_PLUGIN_DIR . 'core/includes/libraries/action-scheduler/action-scheduler.php';
			}
			...
			require_once WPWHPRO_PLUGIN_DIR . 'core/includes/classes/class-wp-webhooks-pro-lists-table-wrapper.php';
			...
			require_once WPWHPRO_PLUGIN_DIR . 'core/includes/classes/class-wp-webhooks-pro-scheduler.php';
			...
			require_once WPWHPRO_PLUGIN_DIR . 'core/includes/classes/class-wp-webhooks-pro-migrate.php';
