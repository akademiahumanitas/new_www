  ...
  class WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_expired_paid {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Paid membership expired', 'wp-webhooks' ),
			'sentence'			  => __( 'a paid membership expired', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a paid membership expired within Restrict Content Pro.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'restrict-content-pro',
			'premium'		   => true,
		);
