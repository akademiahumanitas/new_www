  ...
  class WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_cancelled_free {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Free membership cancelled', 'wp-webhooks' ),
			'sentence'			  => __( 'a free membership was cancelled', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a free membership was cancelled within Restrict Content Pro.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'restrict-content-pro',
			'premium'		   => false,
		);
