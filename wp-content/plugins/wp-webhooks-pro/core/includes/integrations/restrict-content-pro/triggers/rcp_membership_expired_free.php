  ...
  class WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_expired_free {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Free membership expired', 'wp-webhooks' ),
			'sentence'			  => __( 'a free membership expired', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a free membership expired within Restrict Content Pro.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'restrict-content-pro',
			'premium'		   => false,
		);
