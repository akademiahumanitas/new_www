  ...
  class WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_activated_paid {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Paid membership activated', 'wp-webhooks' ),
			'sentence'			  => __( 'a paid membership was activated', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a paid membership was activated within Restrict Content Pro.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'restrict-content-pro',
			'premium'		   => true,
		);
