  ...
  */
  class WP_Webhooks_Integrations_wp_user_manager_Triggers_wpum_update_cover {
	...
	public function get_details(){
		...
		$parameter = array(
			'cover_url' => array( 'short_description' => __( '(String) The URL of the uploaded cover image.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'Cover photo updated', 'wp-webhooks' ),
			'sentence'			  => __( 'a cover photo was updated', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a cover photo was updated within WP User Manager.', 'wp-webhooks' ),
			'description'	   => array(),
