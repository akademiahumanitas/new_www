  ...
  class WP_Webhooks_Integrations_wp_user_manager_Triggers_wpum_user_password_recovered {
	...
	public function get_details(){
		...
		$parameter = array(
			...
			'values' => array( 'short_description' => __( '(Array) All of the updated values.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'User password recovered', 'wp-webhooks' ),
			'sentence'			  => __( 'a user password was recovered', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a user password was recovered within WP User Manager.', 'wp-webhooks' ),
			'description'	   => array(),
