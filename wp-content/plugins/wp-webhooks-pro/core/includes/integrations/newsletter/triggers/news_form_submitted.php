  ...
  */
   ...
   */
	...
	public function get_details(){
		...
		$parameter = array(
			'user' => array( 'short_description' => __( '(Array) The data about the subscribed user.', 'wp-webhooks' ) ),
			'subscribed_lists' => array( 'short_description' => __( '(Array) The lists this user has been subscribed to.', 'wp-webhooks' ) ),
			'subscription' => array( 'short_description' => __( '(Array) The subscription data about the sign up.', 'wp-webhooks' ) ),
		);
		...
		return array(
			...
			'short_description' => __( 'This webhook fires as soon as a form is submitted within The Newsletter Plugin.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'newsletter',
			'premium'		   => false,
		);
