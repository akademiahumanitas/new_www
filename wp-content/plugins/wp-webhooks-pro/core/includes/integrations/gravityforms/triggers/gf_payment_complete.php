...
if ( ! class_exists( 'WP_Webhooks_Integrations_gravityforms_Triggers_gf_payment_complete' ) ) :
	...
	class WP_Webhooks_Integrations_gravityforms_Triggers_gf_payment_complete {
		...
		public function get_details(){
				...
				$parameter = array(
				'entry_id' => array( 'short_description' => __( 'The id of the currently present payment form submission.', 'wp-webhooks' ) ),
				'entry' => array( 'short_description' => __( 'The full entry data of the currently present form submission.', 'wp-webhooks' ) ),
				'action' => array( 'short_description' => __( 'The action data, containing further details about the payment.', 'wp-webhooks' ) ),
			);
			...
			return array(
				...
				'sentence'			  => __( 'a payment was completed', 'wp-webhooks' ),
				'parameter'		 => $parameter,
				'settings'		  => $settings,
				'returns_code'	  => $this->get_demo( array() ),
				'short_description' => __( 'This webhook fires after a Gravity Form Payment is completed.', 'wp-webhooks' ),
				'description'	   => array(),
