...
if ( ! class_exists( 'WP_Webhooks_Integrations_gravityforms_Triggers_gf_submit' ) ) :
	...
	class WP_Webhooks_Integrations_gravityforms_Triggers_gf_submit {
		...
		public function get_details(){
				...
				'lead' => array( 'short_description' => __( 'The full data that was submitted within the form.', 'wp-webhooks' ) ),
				'form' => array( 'short_description' => __( 'The full form data, including field definitions, etc.', 'wp-webhooks' ) ),
			);
			...
			return array(
				...
				'short_description' => __( 'This webhook fires after a Gravity Form submission.', 'wp-webhooks' ),
				'description'	   => array(),
