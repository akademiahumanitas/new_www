  ...
  */
   ...
   */
	...
	public function get_details(){
		...
		$parameter = array(
			'contact_ids' => array( 'short_description' => __( '(Array) All contact ids that have been deleted with this request.', 'wp-webhooks' ) ),
			'contacts' => array( 'short_description' => __( '(Array) All details of the deleted contacts.', 'wp-webhooks' ) ),
		);
		...
		return array(
			...
			'name'			  => __( 'Contact deleted', 'wp-webhooks' ),
			'sentence'			  => __( 'a contact was deleted', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a contact was deleted within FluentCRM.', 'wp-webhooks' ),
			'description'	   => array(),
