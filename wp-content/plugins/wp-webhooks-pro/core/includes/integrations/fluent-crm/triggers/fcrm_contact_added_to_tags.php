  ...
  */
  class WP_Webhooks_Integrations_fluent_crm_Triggers_fcrm_contact_added_to_tags {
	...
	public function get_details(){
		...
		$parameter = array(
			'tag_ids' => array( 'short_description' => __( '(Array) All tag IDs the contact has been assigned to within this request.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'Contact added to tag', 'wp-webhooks' ),
			'sentence'			  => __( 'a contact was added to a tag', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a contact is added to a tag within FluentCRM.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'fluent-crm',
			'premium'		   => false,
		);
