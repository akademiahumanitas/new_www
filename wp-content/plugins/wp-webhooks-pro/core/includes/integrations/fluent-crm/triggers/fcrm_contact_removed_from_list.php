  ...
  */
  class WP_Webhooks_Integrations_fluent_crm_Triggers_fcrm_contact_removed_from_list {
	...
	public function get_details(){
		...
		$parameter = array(
			'list_ids' => array( 'short_description' => __( '(Array) All list IDs the contact have been removed from this request.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'sentence'			  => __( 'a contact was removed from a list', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a contact was removed from a list within FluentCRM.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'fluent-crm',
			'premium'		   => true,
		);
