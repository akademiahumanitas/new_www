  ...
  */
   ...
   */
	...
	public function get_details(){
		...
		$parameter = array(
			'form_data' => array( 'short_description' => __( '(Array) The data that was submitted within the form.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'short_description' => __( 'This webhook fires as soon as a form is submitted within Fluent Forms.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'fluent-forms',
			'premium'		   => false,
		);
