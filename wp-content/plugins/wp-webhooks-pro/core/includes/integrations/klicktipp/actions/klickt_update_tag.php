	...
	public function get_details(){
		...
		$parameter = array(
			...
			'tag_id'		=> array( 
				...
				'short_description' => __( 'The ID of the tag you want to update.', 'wp-webhooks' ),
			),
			'name'		=> array(
		...
		return array(
			...
			'name'			   => __( 'Update tag', 'wp-webhooks' ),
			'sentence'			   => __( 'update a tag', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'returns'		   => $returns,
			'returns_code'	  => $returns_code,
			'short_description' => __( 'Update a tag within "KlickTipp".', 'wp-webhooks' ),
			'description'	   => array(),
		...
		public function execute( $return_data, $response_body ){
			...
			if( ! empty( $connector ) ){
				...
				if( ! empty( $tag ) ){
					...
					$return_args['msg'] = __( "The tag was successfully updated.", 'wp-webhooks' );
				} else {
					$return_args['msg'] = __( "An error occured while updating the tag.", 'wp-webhooks' );
