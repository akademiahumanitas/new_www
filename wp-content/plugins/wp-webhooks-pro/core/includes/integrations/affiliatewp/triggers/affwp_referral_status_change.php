  ...
  public function get_callbacks(){
   ...
   return array(
	...
	public function get_details(){
	  ...
	  $parameter = array(
		'referral_id' => array( 'short_description' => __( 'The id of the referral that the status was changed of.', 'wp-webhooks' ) ),
		'referral' => array( 'short_description' => __( 'Further data about the referral.', 'wp-webhooks' ) ),
		'status' => array( 'short_description' => __( 'The new referral status.', 'wp-webhooks' ) ),
		'old_status' => array( 'short_description' => __( 'The old referral status.', 'wp-webhooks' ) ),
		'affiliate_id' => array( 'short_description' => __( 'The id of the connected affiliate.', 'wp-webhooks' ) ),
		...
		'data' => array(
		  'wpwhpro_affwp_referral_status_change_trigger_on_status' => array(
			...
			'label'	=> __( 'Trigger on selected referral status', 'wp-webhooks' ),
			'placeholder' => '',
			'required'  => false,
			'description' => __( 'Select only the referral status you want to fire the trigger on. If none is selected, all are triggered.', 'wp-webhooks' )
		  ),
	  ...
	  return array(
		...
		'name'	   => __( 'Referral status changed', 'wp-webhooks' ),
		'sentence'	   => __( 'a referral status changed', 'wp-webhooks' ),
		'parameter'	 => $parameter,
		'settings'	 => $settings,
		'returns_code'   => $this->get_demo( array() ),
		'short_description' => __( 'This webhook fires after an referral status was changed within AffiliateWP.', 'wp-webhooks' ),
		'description'	=> array(),
		'integration'	=> 'affiliatewp',
		'premium'	=> true,
	  );
