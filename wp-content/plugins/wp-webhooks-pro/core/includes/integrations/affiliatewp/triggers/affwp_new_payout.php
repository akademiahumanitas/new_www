  ...
  public function get_callbacks(){
   ...
   return array(
	...
	public function get_details(){
	  ...
	  $parameter = array(
		'payout_id' => array( 'short_description' => __( 'The id of the created payout.', 'wp-webhooks' ) ),
		'payout' => array( 'short_description' => __( 'Further data about the payout.', 'wp-webhooks' ) ),
		'affiliate_id' => array( 'short_description' => __( 'The affiliate id of the related affiliate.', 'wp-webhooks' ) ),
		'affiliate' => array( 'short_description' => __( 'Further data about the affiliate.', 'wp-webhooks' ) ),
	  ...
	  return array(
		...
		'name'	   => __( 'New payout', 'wp-webhooks' ),
		'sentence'	   => __( 'a new payout was received', 'wp-webhooks' ),
		'parameter'	 => $parameter,
		'settings'	 => $settings,
		'returns_code'   => $this->get_demo( array() ),
		'short_description' => __( 'This webhook fires after a new payout was received within AffiliateWP.', 'wp-webhooks' ),
		'description'	=> array(),
