  ...
  public function get_callbacks(){
   ...
   return array(
	...
	public function get_details(){
	  ...
	  $parameter = array(
		'affiliate_id' => array( 'short_description' => __( 'The affiliate id of the created affiliate.', 'wp-webhooks' ) ),
		'status' => array( 'short_description' => __( 'The status of the currently created affiliate.', 'wp-webhooks' ) ),
		'args' => array( 'short_description' => __( 'Further information about the affiliate.', 'wp-webhooks' ) ),
		...
		'data' => array(
		  'wpwhpro_affwp_new_affiliate_trigger_on_status' => array(
			...
			'placeholder' => '',
			'required'  => false,
			'description' => __( 'Select only the affiliate status you want to fire the trigger on.', 'wp-webhooks' )
		  ),
		)
	  );
	  ...
	  return array(
		...
		'name'	   => __( 'New affiliate', 'wp-webhooks' ),
		'sentence'	   => __( 'a new affiliate signed up', 'wp-webhooks' ),
		'parameter'	 => $parameter,
		'settings'	 => $settings,
		'returns_code'   => $this->get_demo( array() ),
		'short_description' => __( 'This webhook fires after a new affiliate signed up within AffiliateWP.', 'wp-webhooks' ),
		'description'	=> array(),
		'integration'	=> 'affiliatewp',
		'premium'	=> false,
	  );
