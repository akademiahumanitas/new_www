  ...
  */
   ...
   */
    ...
    public function get_details(){
        ...
        $parameter = array(
            'charge' => array( 'short_description' => __( '(Array) All required payment details.', 'wp-webhooks' ) ),
            'metadata' => array( 'short_description' => __( '(Array) Further data about the form such as the form id within WordPress.', 'wp-webhooks' ) ),
        );
        ...
        return array(
            ...
            'name'              => __( 'Purchase completed', 'wp-webhooks' ),
            'sentence'              => __( 'a purchase was completed', 'wp-webhooks' ),
            'parameter'         => $parameter,
            'settings'          => $settings,
            'returns_code'      => $this->get_demo( array() ),
            'short_description' => __( 'This webhook fires as soon as a new payment was made within WP Simple Pay.', 'wp-webhooks' ),
            'description'       => array(),
