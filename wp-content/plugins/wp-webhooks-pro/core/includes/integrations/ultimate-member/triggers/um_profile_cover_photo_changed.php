...
if ( ! class_exists( 'WP_Webhooks_Integrations_ultimate_member_Triggers_um_profile_cover_photo_changed' ) ) :

    /**
     * Load the um_profile_cover_photo_changed trigger
     *
     * @since 5.2.2
     * @author Ironikus <info@ironikus.com>
     */
    class WP_Webhooks_Integrations_ultimate_member_Triggers_um_profile_cover_photo_changed{
        ...
        public function get_callbacks(){
            ...
            return array(
                array(
                    'type' => 'filter',
                    'hook' => 'um_upload_image_process__cover_photo',
                    'callback' => array( $this, 'wpwh_trigger_um_profile_cover_photo_changed' ),
                    'priority' => 10,
                    'arguments' => 7,
                    'delayed' => true,
                ),
        ...
        public function get_details(){
            ...
            $settings = array(
                ...
                'data'=> array(
                    'wpwhpro_um_profile_cover_photo_changed_trigger_on_users' => array(
                        'id'			=> 'wpwhpro_um_profile_cover_photo_changed_trigger_on_users',
                        'type'			=> 'select',
                        'multiple'		=> true,
                        'choices'		=> array(),
                        'query'			=> array(
            ...
            return array(
                'trigger'		  => 'um_profile_cover_photo_changed',
                'name'			  => __( 'Profile cover photo changed', 'wp-webhooks' ),
                'sentence'		  => __( 'a profile cover photo was changed', 'wp-webhooks' ),
                'parameter'		  => $parameter,
                'settings'		  => $settings,
                'returns_code'	  => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires after UM\'s profile cover photo was changed.', 'wp-webhooks' ),
                'description'	   => array(),
        ...
        /**
         * Triggers once Profile cover photo is changed
         *
         ...
         *
         */
        public function wpwh_trigger_um_profile_cover_photo_changed($response, $image_path, $src, $key, $user_id, $coord, $crop){
            $webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'um_profile_cover_photo_changed' );
            ...
            foreach( $webhooks as $webhook ){
                ...
                if( isset( $webhook['settings'] ) ){
                    foreach( $webhook['settings'] as $settings_name => $settings_data ) {
                        if( $settings_name === 'wpwhpro_um_profile_cover_photo_changed_trigger_on_users' && ! empty( $settings_data ) ){
            ...
            do_action( 'wpwhpro/webhooks/trigger_um_profile_cover_photo_changed', $payload, $response_data_array );
        }
