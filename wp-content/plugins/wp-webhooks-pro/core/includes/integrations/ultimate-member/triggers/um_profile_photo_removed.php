...
if ( ! class_exists( 'WP_Webhooks_Integrations_ultimate_member_Triggers_um_profile_photo_removed' ) ) :

    /**
     * Load the um_profile_photo_removed trigger
     *
     * @since 5.2.2
     * @author Ironikus <info@ironikus.com>
     */
    class WP_Webhooks_Integrations_ultimate_member_Triggers_um_profile_photo_removed{
        ...
        public function get_callbacks(){
            ...
            return array(
                array(
                    'type' => 'action',
                    'hook' => 'um_after_remove_profile_photo',
                    'callback' => array( $this, 'wpwh_trigger_um_profile_photo_removed' ),
                    'priority' => 10,
                    'arguments' => 1,
                    'delayed' => true,
                ),
        ...
        public function get_details(){
            ...
            $settings = array(
                ...
                'data' => array(
                    'wpwhpro_um_profile_photo_removed_trigger_on_users' => array(
                        'id'			=> 'wpwhpro_um_profile_photo_removed_trigger_on_users',
                        'type'			=> 'select',
                        'multiple'		=> true,
                        'choices'		=> array(),
                        'query'			=> array(
            ...
            return array(
                'trigger'		  => 'um_profile_photo_removed',
                'name'			  => __( 'Profile photo removed', 'wp-webhooks' ),
                'sentence'		  => __( 'a profile photo was removed', 'wp-webhooks' ),
                'parameter'		  => $parameter,
                'settings'		  => $settings,
                'returns_code'	  => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires after UM\'s profile photo was removed.', 'wp-webhooks' ),
                'description'	   => array(),
        ...
        /**
         * Triggers once a Webhook name
         *
         * @param integer $user_id
         */
        public function wpwh_trigger_um_profile_photo_removed($user_id){
            $webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'um_profile_photo_removed' );
            ...
            foreach( $webhooks as $webhook ){
                ...
                if( isset( $webhook['settings'] ) ){
                    foreach( $webhook['settings'] as $settings_name => $settings_data ) {
                        if( $settings_name === 'wpwhpro_um_profile_photo_removed_trigger_on_users' && ! empty( $settings_data ) ){
            ...
            do_action( 'wpwhpro/webhooks/trigger_um_profile_photo_removed', $payload, $response_data_array );
        }
