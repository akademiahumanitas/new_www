...
if ( ! class_exists( 'WP_Webhooks_Integrations_ultimate_member_Triggers_um_account_marked_inactive' ) ) :

    /**
     * Load the um_account_marked_inactive trigger
     *
     * @since 5.2.2
     * @author Ironikus <info@ironikus.com>
     */
    class WP_Webhooks_Integrations_ultimate_member_Triggers_um_account_marked_inactive{
        ...
        public function get_callbacks(){
            ...
            return array(
                array(
                    ...
                    'callback' => array( $this, 'wpwh_trigger_um_account_marked_inactive' ),
                    'priority' => 10,
                    'arguments' => 1,
                    'delayed' => true,
                ),
        ...
        public function get_details(){
            ...
            $settings = array(
                ...
                'data' => array(
                    'wpwhpro_um_account_marked_inactive_trigger_on_users' => array(
            ...
            return array(
                'trigger'		  => 'um_account_marked_inactive',
                'name'			  => __( 'Account marked inactive', 'wp-webhooks' ),
                'sentence'		  => __( 'an account was marked inactive', 'wp-webhooks' ),
                'parameter'		  => $parameter,
                'settings'		  => $settings,
                'returns_code'	  => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires after UM account was marked inactive.', 'wp-webhooks' ),
                'description'	   => array(),
        ...
        /**
         * Triggers once a Account marked inactive
         *
         * @param integer $user_id
         */
        public function wpwh_trigger_um_account_marked_inactive($user_id){
            $webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'um_account_marked_inactive' );
            ...
            foreach( $webhooks as $webhook ){
                ...
                if( isset( $webhook['settings'] ) ){
                    foreach( $webhook['settings'] as $settings_name => $settings_data ) {
                        if( $settings_name === 'wpwhpro_um_account_marked_inactive_trigger_on_users' && ! empty( $settings_data ) ){
            ...
            do_action( 'wpwhpro/webhooks/trigger_um_account_marked_inactive', $payload, $response_data_array );
        }
