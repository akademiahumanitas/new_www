	...
	public function get_details(){
		...
		$description = array(
			'steps' => array(
				...
				__( 'Head into Zapier and select the "Webhooks by Zapier" app along with the "POST" or "Custom Request" action.', 'wp-webhooks' ),
		...
		return array(
			...
			'name'			  => __( 'Zapier webhook request received', 'wp-webhooks' ),
			'sentence'			  => __( 'a Zapier webhook request was received', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => sprintf( __( 'This webhook fires as soon as a request was received from the "Webhooks by Zapier" app of Zapier with the action "POST" or "Custom Request".', 'wp-webhooks' ), WPWHPRO()->settings->get_page_title() ),
