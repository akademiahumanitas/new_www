  ...
  class WP_Webhooks_Integrations_wp_courseware_Triggers_wpcw_module_completed {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Module completed', 'wp-webhooks' ),
			'sentence'			  => __( 'a user completed a module', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a user completed a module within WP Courseware.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'wp-courseware',
			'premium'		   => false,
		);
