  ...
  class WP_Webhooks_Integrations_wp_courseware_Triggers_wpcw_course_completed {
	...
	public function get_details(){
		...
		return array(
			...
			'sentence'			  => __( 'a user completed a course', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a user completed a course within WP Courseware.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'wp-courseware',
			'premium'		   => false,
		);
