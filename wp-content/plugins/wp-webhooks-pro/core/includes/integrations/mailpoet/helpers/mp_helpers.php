...
if ( ! class_exists( 'WP_Webhooks_Integrations_mailpoet_Helpers_mp_helpers' ) ) :
	 ...
	 */
	class WP_Webhooks_Integrations_mailpoet_Helpers_mp_helpers {
        ...
        public function get_query_forms( $entries, $query_args, $args){
			...
			if( class_exists('MailPoet\Form\FormsRepository') ){
