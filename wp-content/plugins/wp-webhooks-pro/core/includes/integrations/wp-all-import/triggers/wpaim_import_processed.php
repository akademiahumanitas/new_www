  ...
  */
  class WP_Webhooks_Integrations_wp_all_import_Triggers_wpaim_import_processed {
	...
	public function get_details(){
		...
		$parameter = array(
			'import_id' => array( 'short_description' => __( '(Integer) The id of the import.', 'wp-webhooks' ) ),
			'import' => array( 'short_description' => __( '(Array) Further details about the import.', 'wp-webhooks' ) ),
		);
		...
		$settings = array(
			...
			'data' => array(
				'wpwhpro_wp_all_import_trigger_on_selected_imports' => array(
					...
					'label'	   => __( 'Trigger on selected imports', 'wp-webhooks' ),
					'placeholder' => '',
					'required'	=> false,
					'description' => __( 'Select only the imports you want to fire the trigger on. You can also choose multiple ones. If none is selected, all are triggered.', 'wp-webhooks' )
				),
			)
		);
		...
		return array(
			...
			'name'			  => __( 'Import processed', 'wp-webhooks' ),
			'sentence'			  => __( 'an import was processed', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as an import was processed within WP All Import.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'wp-all-import',
			'premium'		   => true,
		);
