   ...
   */
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'License activated', 'wp-webhooks' ),
			'sentence'			  => __( 'a license was activated', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires on activation of a license within Easy Digital Downloads.', 'wp-webhooks' ),
			'description'	   => array(),
