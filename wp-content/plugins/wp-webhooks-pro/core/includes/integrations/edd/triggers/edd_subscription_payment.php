  ...
  */
   ...
   */
	...
	public function get_details(){
		...
		$parameter = array(
			'payment' => array( 'short_description' => __( '(Array) The payment data. For further details, please refer to the example down below.', 'wp-webhooks' ) ),
			'subscription' => array( 'short_description' => __( '(Array) The subscription data. For further details, please refer to the example down below.', 'wp-webhooks' ) ),
		);
		...
		return array(
			...
			'name'			  => __( 'Subscription payment created', 'wp-webhooks' ),
			'sentence'			  => __( 'a new subscription payment was created', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a new subscription payment is created within Easy Digital Downloads.', 'wp-webhooks' ),
			'description'	   => array(),
