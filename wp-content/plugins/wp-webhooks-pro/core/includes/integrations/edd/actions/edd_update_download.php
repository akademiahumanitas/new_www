...
if ( ! class_exists( 'WP_Webhooks_Integrations_edd_Actions_edd_update_download' ) ) :
	...
	class WP_Webhooks_Integrations_edd_Actions_edd_update_download {
        ...
        public function get_details(){
            ...
            $parameter = array(
				'download_id'           		=> array( 'required' => true, 'short_description' => __( '(Integer) The ID of the existing download', 'wp-webhooks' ) ),
				'create_if_none'           		=> array( 
					...
					'multiple' => false,
					'default_value' => 'no',
					'short_description' => __( '(String) Set this value to "yes" to create the download in case the given download id does not exist. Default: no', 'wp-webhooks' ),
				),
			...
			ob_start();
			?>
<?php echo __( "Set this value to <strong>yes</strong> to create the download in case it does not exist yet.", 'wp-webhooks' ); ?>
			<?php
...
<?php echo __( "In case you set this value to <strong>yes</strong>, the default <strong>edd_price</strong> is ignored.", 'wp-webhooks' ); ?>
			...
			ob_start();
			?>
<?php echo __( "This argument accepts a JSON formatted string of the variations you want to update. Down below, you will find an example, containing all values you can set. Please not that defining this argument, it will replace all previously set variations.", 'wp-webhooks' ); ?>
...
<?php echo __( "The default price id of the variation you want to set as the fault. You only need to set this value in case you set <strong>is_variable_pricing</strong> to yes.", 'wp-webhooks' ); ?>
			...
			ob_start();
			?>
<?php echo __( "This argument accepts a JSON formatted string of the downloadable files you want to add to the download. Down below, you will find an example, containing all values you can set. Please not that defining this argument, it will replace all previously set download files within this argument.", 'wp-webhooks' ); ?>
...
<ol>
    ...
    <?php do_action( 'wpwh/descriptions/actions/edd_update_download/after_edd_download_files_items', $default_download_files ); ?>
			...
			ob_start();
			?>
<?php echo __( "This argument allows you to create download bundles. This argument accepts a JSON formatted string of the downloadads you want to bundle. You can also target only a specific variation of a product by defining the variation id, separated by an underscore. Please not that defining this argument, will replace all previously set bundle products within this argument.", 'wp-webhooks' ); ?>
...
<?php echo __( "In case you set the <strong>wp_error</strong> argument to <strong>yes</strong>, we will return the WP Error object within the response if the webhook action call. It is recommended to only use this for debugging.", 'wp-webhooks' ); ?>
			...
			$description = array(
				'tipps' => array(
					__( "In case the download id you provided within the <strong>download_id</strong> argument coult not be found, you can also create the post by defining the <strong>create_if_none</strong> argument with the value <strong>yes</strong>.", 'wp-webhooks' ),
					__( "We currently offer pre-defined fields for the download. If you want to add further meta values, you can use the <strong>meta_input</strong> argument.", 'wp-webhooks' ),
				),
			);

            return array(
                'action'            => 'edd_update_download',
                'name'              => __( 'Update download', 'wp-webhooks' ),
                'sentence'              => __( 'update a download', 'wp-webhooks' ),
                'parameter'         => $parameter,
                'returns'           => $returns,
                'returns_code'      => $returns_code,
                'short_description' => __( 'This webhook action allows you to update (or create) a download within Easy Digital Downloads.', 'wp-webhooks' ),
