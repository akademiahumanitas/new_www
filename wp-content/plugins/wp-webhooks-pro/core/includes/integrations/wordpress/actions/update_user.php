...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Actions_update_user' ) ) :
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id'		   => array( 'short_description' => __( '(Optional if user_email or user_login is defined) Include the numeric id of the user. (Note that the user_id has a higher priority than the user_email.)', 'wp-webhooks' ) ),
			'user_email'		=> array( 'short_description' => __( '(Optional if user_id or user_login is defined) Include the email correlated to the account.', 'wp-webhooks' ) ),
			'user_login'		=> array(
				'short_description' => __( '(Optional if user_email or user_id is defined) A string with which the user can log in to your site. This value can also be used ot update a user.', 'wp-webhooks' ),
				'description' => __( "This argument can also be used to identify a user by the login name. E.g. If you do not provide the user email or user id, we will try to fetch the user from the user login.", 'wp-webhooks' )
			),
			...
			'user_registered'   => array( 'short_description' => __( 'The date the user got registered. Date structure: Y-m-d H:i:s', 'wp-webhooks' ) ),
			'user_url'		  => array( 'short_description' => __( 'Include a website url.', 'wp-webhooks' ) ),
			'role'			  => array( 'short_description' => __( 'The main user role. If set, all additional roles are removed.', 'wp-webhooks' ) ),
			'additional_roles'  => array( 'short_description' => __( 'This allows to add/remove multiple roles on a user. For more information, please read the description.', 'wp-webhooks' ) ),
			'user_pass'		 => array( 'short_description' => __( 'The user password. If not defined, we don\'t generate a new one.', 'wp-webhooks' ) ),
			...
			'create_if_none'	=> array(
				...
				'multiple' => false,
				'default_value' => 'no',
				'short_description' => __( 'Wether you want to create the user if it does not exists or not. Set it to "yes" or "no" Default is "no".', 'wp-webhooks' ),
				'description' => __( "In case you set the <strong>create_if_none</strong> argument to <strong>yes</strong>, a user will be created with the given details in case it does not exist.", 'wp-webhooks' )
			),
			'do_action'		 => array( 'short_description' => __( 'Advanced: Register a custom action after the plugin fires this webhook. More infos are in the description.', 'wp-webhooks' ) ),
		);

		ob_start();
		?>
<?php echo __( "The slug of the role. The default roles have the following slugs:", 'wp-webhooks' ); ?>
<ul>
<li>administrator</li>
<li>editor</li>
<li>author</li>
...
<ol>
   ...
   "add_user_meta":[
	  ...
	  },
	  {
		...
		<?php echo __( "This key refers to the <strong>add_user_meta()</strong> function of WordPress:", 'wp-webhooks' ); ?> <a title="Go to WordPress" target="_blank" href="https://developer.wordpress.org/reference/functions/add_user_meta/">https://developer.wordpress.org/reference/functions/add_user_meta/</a><br>
   ...
   "update_user_meta":[
	  ...
	  },
	  {
		...
		<?php echo __( "This key refers to the <strong>update_user_meta()</strong> function of WordPress:", 'wp-webhooks' ); ?> <a title="Go to WordPress" target="_blank" href="https://developer.wordpress.org/reference/functions/update_user_meta/">https://developer.wordpress.org/reference/functions/update_user_meta/</a><br>
   ...
   "delete_user_meta":[
	  ...
	  },
	  {
		...
		<?php echo __( "This key refers to the <strong>delete_user_meta()</strong> function of WordPress:", 'wp-webhooks' ); ?> <a title="Go to WordPress" target="_blank" href="https://developer.wordpress.org/reference/functions/delete_user_meta/">https://developer.wordpress.org/reference/functions/delete_user_meta/</a><br>
...
<pre>
{
	"meta_key": "Meta Value"
		...
		ob_start();
		?>
<?php echo __( "The <strong>do_action</strong> argument is an advanced webhook for developers. It allows you to fire a custom WordPress hook after the <strong>update_user</strong> action was fired.", 'wp-webhooks' ); ?>
<br>
...
<ol>
	<li>
		...
		<?php echo __( "Contains the data that is used to update the user.", 'wp-webhooks' ); ?>
	</li>
	<li>
		<strong>$user_id</strong> (integer)<br>
		<?php echo __( "Contains the user id of the updated user. Please note that it can also contain a wp_error object since it is the response of the wp_insert_user() function.", 'wp-webhooks' ); ?>
	</li>
	<li>
	...
	<li>
		...
		<?php echo __( "This value will be set to 'true' for the update_user webhook.", 'wp-webhooks' ); ?>
	</li>
</ol>
		<?php
		...
		return array(
			'action'			=> 'update_user',
			'name'			  => __( 'Update user', 'wp-webhooks' ),
			'sentence'			  => __( 'update a user', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'returns'		   => $returns,
			'returns_code'	  => $returns_code,
			'short_description' => __( 'Update a user on your WordPress website or network.', 'wp-webhooks' ),
			'description'	   => array(),
