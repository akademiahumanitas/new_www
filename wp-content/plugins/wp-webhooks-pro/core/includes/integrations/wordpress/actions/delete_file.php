...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Actions_delete_file' ) ) :
	...
	class WP_Webhooks_Integrations_wordpress_Actions_delete_file {
		...
		public function get_details(){
				...
				$parameter = array(
				'file'	   => array( 'required' => true, 'short_description' => __( 'The path as well as the file name and extension. For example: wp-content/themes/demo-theme/index.php', 'wp-webhooks' ) ),
				'do_action'	 => array( 'short_description' => __( 'Advanced: Register a custom action after Webhooks Pro fires this webhook.', 'wp-webhooks' ) )
			);

			ob_start();
			?>
<p><?php echo __( 'In case you want to delete a file within the WordPress root folder, just declare the file:', 'wp-webhooks' ); ?></p>
<br>
<pre>demo.php</pre>
				<?php
...
<ol>
	...
	<li>
		...
		<?php echo __( "The relative path of the file you deleted.", 'wp-webhooks' ); ?>
	</li>
</ol>
			<?php
			...
			$description = array(
				'tipps' => array(
					__( 'For security reasons, we restrict the deletion of files to the WordPress root folder and its sub folders. This means, that you have to define the path in a relative way. Here is an example:', 'wp-webhooks' ) . '<code>wp-content/themes/demo-theme/index.php</code>',
				),
			);

			return array(
				'action'			=> 'delete_file',
				'name'			  => __( 'Delete file', 'wp-webhooks' ),
				'sentence'			  => __( 'delete a file', 'wp-webhooks' ),
				'parameter'		 => $parameter,
				'returns'		   => $returns,
				'returns_code'	  => $returns_code,
				'short_description' => __( 'Delete a file via a webhook inside of your WordPress folder structure.', 'wp-webhooks' ),
		...
		public function execute( $return_data, $response_body ){
			...
			if( ! empty( $file ) ){
				...
				if( $check ){
					$return_args['msg'] = __( "File successfully deleted.", 'wp-webhooks' );
					$return_args['success'] = true;
				} else {
					$return_args['msg'] = __( "File was not deleted because of an error or because it does not exist.", 'wp-webhooks' );
				}
			}
