        ...
        */
        public function get_details(){
            ...
            $parameter = array(
                ...
                'user_login'    => array( 'short_description' => __( 'The user login is included as well. This is the value the user used to make the login. It is also located on the first layoer of the array.', 'wp-webhooks' ) ),
            );
            ...
            return array(
                ...
                'sentence'              => __( 'a user has logged in', 'wp-webhooks' ),
                'parameter'         => $parameter,
                'returns_code'      => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires as soon as a user triggers the login.', 'wp-webhooks' ),
                'description'       => array(),
