...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Triggers_deleted_user' ) ) :
	...
	class WP_Webhooks_Integrations_wordpress_Triggers_deleted_user {
        ...
        public function get_details(){
            ...
            $parameter = array(
                'user_id'   	=> array( 'short_description' => __( 'The ID of the deleted user', 'wp-webhooks' ) ),
                'reassign'     	=> array( 'short_description' => __( 'ID of the user to reassign posts and links to. Default null, for no reassignment.', 'wp-webhooks' ) ),
                'user'     		=> array( 'short_description' => __( 'The full user data from the WP_User object.', 'wp-webhooks' ) ),
                'user_meta'     => array( 'short_description' => __( 'All of the assigned user meta of the given user.', 'wp-webhooks' ) ),
            );
            ...
            return array(
                ...
                'name'              => __( 'User deleted', 'wp-webhooks' ),
                'sentence'              => __( 'a user was deleted', 'wp-webhooks' ),
                'parameter'         => $parameter,
                'returns_code'      => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires as soon as a user was deleted.', 'wp-webhooks' ),
                'description'       => array(),
