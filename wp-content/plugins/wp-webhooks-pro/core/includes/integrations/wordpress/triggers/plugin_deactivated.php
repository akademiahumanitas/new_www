	...
	class WP_Webhooks_Integrations_wordpress_Triggers_plugin_deactivated {
        ...
        public function get_details(){
            ...
            $parameter = array(
				...
				'network_wide' => array( 'short_description' => __( '(Bool) True if the plugin was deactivated for the whole network of a multisite, false if not.', 'wp-webhooks' ) ),
			);
            ...
            return array(
                ...
                'name'              => __( 'Plugin deactivated', 'wp-webhooks' ),
                'sentence'              => __( 'a plugin was deactivated', 'wp-webhooks' ),
                'parameter'         => $parameter,
                'settings'          => $settings,
                'returns_code'      => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires as soon as a plugin was deactivated.', 'wp-webhooks' ),
                'description'       => array(),
