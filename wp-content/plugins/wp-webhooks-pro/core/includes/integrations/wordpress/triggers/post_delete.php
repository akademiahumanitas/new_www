...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Triggers_post_delete' ) ) :
	...
	class WP_Webhooks_Integrations_wordpress_Triggers_post_delete {
        ...
        public function get_details(){
            ...
            $parameter = array(
                'post_id' => array( 'short_description' => __( 'The post id of the deleted post.', 'wp-webhooks' ) ),
            ...
            return array(
                'trigger'           => 'post_delete',
                'name'              => __( 'Post deleted', 'wp-webhooks' ),
                'sentence'              => __( 'a post was deleted', 'wp-webhooks' ),
                'parameter'         => $parameter,
                'settings'          => $settings,
                'returns_code'      => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires after a post was deleted.', 'wp-webhooks' ),
                'description'       => array(),
