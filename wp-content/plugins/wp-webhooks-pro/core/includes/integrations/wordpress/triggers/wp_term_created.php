<?php
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Triggers_wp_term_created' ) ) :

	/**
	 * Load the wp_term_created trigger
	 *
	 * @since 5.2.6
	 * @author Ironikus <info@ironikus.com>
	 */
	class WP_Webhooks_Integrations_wordpress_Triggers_wp_term_created {
		...
		public function get_callbacks(){
            ...
            return array(
                array(
                    'type' => 'action',
                    'hook' => 'created_term',
                    'callback' => array( $this, 'ironikus_trigger_wp_term_created' ),
                    'priority' => 20,
                    'arguments' => 3,
                    'delayed' => true,
                ),
        ...
        public function get_details(){
            ...
            return array(
                'trigger'           => 'wp_term_created',
                'name'              => __( 'Taxonomy term created', 'wp-webhooks' ),
                'sentence'              => __( 'a taxonomy term was created', 'wp-webhooks' ),
                'parameter'         => $parameter,
                'settings'          => $settings,
                'returns_code'      => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires after a taxonomy term was created.', 'wp-webhooks' ),
                'description'       => array(), 
        ...
        public function ironikus_trigger_wp_term_created( $term_id, $tt_id, $taxonomy ){

			$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'wp_term_created' );
			$data_array = array(
				'term_id' => $term_id,
				'taxonomy_id' => $tt_id,
