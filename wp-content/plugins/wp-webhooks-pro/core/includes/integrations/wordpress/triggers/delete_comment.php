...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Triggers_delete_comment' ) ) :
	...
	class WP_Webhooks_Integrations_wordpress_Triggers_delete_comment {
        ...
        public function get_details(){
			...
			$parameter = array(
				'comment_id'   => array( 'short_description' => __( 'The comment id of the currently deleted comment.', 'wp-webhooks' ) ),
				'comment_data'   => array( 'short_description' => __( 'The full data object of the comment.', 'wp-webhooks' ) ),
				'current_post_id'   => array( 'short_description' => __( 'The post id of the post the comment was deleted on.', 'wp-webhooks' ) ),
            ...
            return array(
                ...
                'name'              => __( 'Comment deleted', 'wp-webhooks' ),
                'sentence'              => __( 'a comment was deleted', 'wp-webhooks' ),
                'parameter'         => $parameter,
                'settings'          => $settings,
                'returns_code'      => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires after a comment was deleted.', 'wp-webhooks' ),
                'description'       => array(),
