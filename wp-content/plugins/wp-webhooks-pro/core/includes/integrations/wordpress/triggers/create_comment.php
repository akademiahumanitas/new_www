...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Triggers_create_comment' ) ) :
	...
	class WP_Webhooks_Integrations_wordpress_Triggers_create_comment {
        ...
        public function get_details(){
			...
			$parameter = array(
				'comment_id'   => array( 'short_description' => __( 'The comment id of the currently created comment.', 'wp-webhooks' ) ),
				'comment_data'   => array( 'short_description' => __( 'The full data object of the comment.', 'wp-webhooks' ) ),
				'current_post_id'   => array( 'short_description' => __( 'The post id of the post the comment was created on.', 'wp-webhooks' ) ),
				'current_post_data'   => array( 'short_description' => __( 'The full data of the current post.', 'wp-webhooks' ) ),
				'user_id'   => array( 'short_description' => __( 'The id of the user who posted the comment (In case it is given).', 'wp-webhooks' ) ),
				'user_data'   => array( 'short_description' => __( 'The full data of the user of the comment (In case a user is given).', 'wp-webhooks' ) ),
			);
            ...
            return array(
                ...
                'name'              => __( 'Comment created', 'wp-webhooks' ),
                'sentence'              => __( 'a comment was created', 'wp-webhooks' ),
                'parameter'         => $parameter,
                'settings'          => $settings,
                'returns_code'      => $this->get_demo( array() ),
                'short_description' => __( 'This webhook fires after a new comment was created.', 'wp-webhooks' ),
                'description'       => array(),
