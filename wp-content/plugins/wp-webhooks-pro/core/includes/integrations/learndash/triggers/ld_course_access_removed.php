  ...
  */
  class WP_Webhooks_Integrations_learndash_Triggers_ld_course_access_removed {
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id' => array( 'short_description' => __( '(Integer) The id of the user that got access removed from the course.', 'wp-webhooks' ) ),
			'course_id' => array( 'short_description' => __( '(Integer) The id of the course the user got access removed.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'Course access removed', 'wp-webhooks' ),
			'sentence'			  => __( 'a course access was removed', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a course access was removed for a user within LearnDash.', 'wp-webhooks' ),
			'description'	   => array(),
