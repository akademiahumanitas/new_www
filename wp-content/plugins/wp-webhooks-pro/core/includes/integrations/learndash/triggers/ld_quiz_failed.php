  ...
  */
  class WP_Webhooks_Integrations_learndash_Triggers_ld_quiz_failed {
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id' => array( 'short_description' => __( '(Integer) The id of the user that failed the course.', 'wp-webhooks' ) ),
			'course_id' => array( 'short_description' => __( '(Integer) The ID of the failed course.', 'wp-webhooks' ) ),
			...
			'question_show_count' => array( 'short_description' => __( '(learndash_quiz_submitted) A count of how often the question has been shown.', 'wp-webhooks' ) ),
			...
			'time' => array( 'short_description' => __( '(Integer) A timestamp of the time the quiz was failed.', 'wp-webhooks' ) ),
			...
			'completed' => array( 'short_description' => __( '(Integer) A timestamp of the time the quiz was initially completed.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'Quiz failed', 'wp-webhooks' ),
			'sentence'			  => __( 'a quiz was failed', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a quiz was failed within LearnDash.', 'wp-webhooks' ),
			'description'	   => array(),
