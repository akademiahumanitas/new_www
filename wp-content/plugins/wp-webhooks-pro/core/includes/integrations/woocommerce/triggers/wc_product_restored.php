  ...
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_product_restored {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Product restored', 'wp-webhooks' ),
			'sentence'			  => __( 'a product was restored', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a product was restored within Woocommerce.', 'wp-webhooks' ),
