  ...
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_product_updated {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Product updated', 'wp-webhooks' ),
			'sentence'			  => __( 'a product was updated', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a product was updated within Woocommerce.', 'wp-webhooks' ),
