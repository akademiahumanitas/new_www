  ...
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_coupon_restored {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Coupon restored', 'wp-webhooks' ),
			'sentence'			  => __( 'a coupon was restored', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a coupon was restored within Woocommerce.', 'wp-webhooks' ),
