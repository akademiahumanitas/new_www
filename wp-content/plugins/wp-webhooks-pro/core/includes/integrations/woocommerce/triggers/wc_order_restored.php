  ...
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_order_restored {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Order restored', 'wp-webhooks' ),
			'sentence'			  => __( 'an order was restored', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as an order was restored within Woocommerce.', 'wp-webhooks' ),
