  ...
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_coupon_updated {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Coupon updated', 'wp-webhooks' ),
			'sentence'			  => __( 'a coupon was updated', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a coupon was updated within Woocommerce.', 'wp-webhooks' ),
