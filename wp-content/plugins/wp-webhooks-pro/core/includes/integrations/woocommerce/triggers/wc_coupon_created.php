  ...
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_coupon_created {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Coupon created', 'wp-webhooks' ),
			'sentence'			  => __( 'a coupon was created', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a coupon was created within Woocommerce.', 'wp-webhooks' ),
