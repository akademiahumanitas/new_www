  ...
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_product_deleted {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Product deleted', 'wp-webhooks' ),
			'sentence'			  => __( 'a product was deleted', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a product was deleted within Woocommerce.', 'wp-webhooks' ),
