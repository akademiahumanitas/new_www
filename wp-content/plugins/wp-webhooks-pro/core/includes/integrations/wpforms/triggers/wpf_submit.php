  ...
  public function get_callbacks(){
   ...
   return array(
	...
	public function get_details(){
	  ...
	  $parameter = array(
		'form_id' => array( 'short_description' => __( 'The id of the form that was currently submitted.', 'wp-webhooks' ) ),
		'entry_id' => array( 'short_description' => __( 'The id of the current form submission.', 'wp-webhooks' ) ),
		'entry' => array( 'short_description' => __( 'The full data that was submitted within the form.', 'wp-webhooks' ) ),
		'fields' => array( 'short_description' => __( 'The full form data, including field definitions, etc.', 'wp-webhooks' ) ),
	  );
	  ...
	  return array(
		...
		'short_description' => __( 'This webhook fires after a WPForms form submission.', 'wp-webhooks' ),
		'description'	=> array(),
