  ...
  class WP_Webhooks_Integrations_woocommerce_subscriptions_Triggers_wcs_subscription_trial_ended {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Subscription trial ended', 'wp-webhooks' ),
			'sentence'			  => __( 'a subscription trial ended', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a subscription trial ended within WooCommerce Subscriptions.', 'wp-webhooks' ),
			'description'	   => array(),
