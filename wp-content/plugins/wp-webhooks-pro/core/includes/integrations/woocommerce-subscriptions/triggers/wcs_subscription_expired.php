  ...
  class WP_Webhooks_Integrations_woocommerce_subscriptions_Triggers_wcs_subscription_expired {
	...
	public function get_details(){
		...
		return array(
			...
			'sentence'			  => __( 'a subscription expired', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a subscription expired within WooCommerce Subscriptions.', 'wp-webhooks' ),
			'description'	   => array(),
