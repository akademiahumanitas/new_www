  ...
  */
  class WP_Webhooks_Integrations_groundhogg_Triggers_ghogg_contact_tag_added {
	...
	public function get_details(){
		...
		$parameter = array(
			'tag_id' => array( 'short_description' => __( '(Integer) The id of the tag that was added.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'Contact tag added', 'wp-webhooks' ),
			'sentence'			  => __( 'a tag was added to a contact', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a tag was added to a contact within Groundhogg.', 'wp-webhooks' ),
			'description'	   => array(),
