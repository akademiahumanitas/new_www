  ...
  */
  class WP_Webhooks_Integrations_woocommerce_memberships_Triggers_wcm_membership_cancelled {
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id' => array( 'short_description' => __( '(Integer) The ID of the user the membership was cancelled for.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'Membership cancelled', 'wp-webhooks' ),
			'sentence'			  => __( 'a membership was cancelled', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a membership was cancelled within WooCommerce Memberships.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'woocommerce-memberships',
			'premium'		   => true,
		);
