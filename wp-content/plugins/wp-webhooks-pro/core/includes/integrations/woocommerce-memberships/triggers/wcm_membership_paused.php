  ...
  */
  class WP_Webhooks_Integrations_woocommerce_memberships_Triggers_wcm_membership_paused {
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id' => array( 'short_description' => __( '(Integer) The ID of the user the membership was paused for.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'Membership paused', 'wp-webhooks' ),
			'sentence'			  => __( 'a membership was paused', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a membership was paused within WooCommerce Memberships.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'woocommerce-memberships',
			'premium'		   => true,
		);
