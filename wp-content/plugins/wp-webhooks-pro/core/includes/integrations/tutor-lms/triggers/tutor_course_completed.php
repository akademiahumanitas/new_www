  ...
  public function get_callbacks(){
   ...
   return array(
	...
	public function get_details(){
	  ...
	  $parameter = array(
		'user_id' => array( 'short_description' => __( '(Integer) The id of the user that has completed the course.', 'wp-webhooks' ) ),
		'course_id' => array( 'short_description' => __( '(Integer) The id of the course that has been completed.', 'wp-webhooks' ) ),
		'course' => array( 'short_description' => __( '(Array) Further details about the course.', 'wp-webhooks' ) ),
		'course_meta' => array( 'short_description' => __( '(Array) The course meta data.', 'wp-webhooks' ) ),
		'course_price' => array( 'short_description' => __( '(String) The course price', 'wp-webhooks' ) ),
		'course_product_id' => array( 'short_description' => __( '(Integer) The course product id.', 'wp-webhooks' ) ),
		'course_rating' => array( 'short_description' => __( '(Array) The course rating.', 'wp-webhooks' ) ),
		'course_rating_user' => array( 'short_description' => __( '(Array) the course rating based on the course user.', 'wp-webhooks' ) ),
		'course_completed' => array( 'short_description' => __( '(Array) Further data about the completion.', 'wp-webhooks' ) ),
		'course_settings' => array( 'short_description' => __( '(Array) Course settings.', 'wp-webhooks' ) ),
		'course_duration' => array( 'short_description' => __( '(Array) Further data about the course duration.', 'wp-webhooks' ) ),
	  );
	  ...
	  return array(
		...
		'short_description' => __( 'This webhook fires after a Tutor LMS course was completed.', 'wp-webhooks' ),
		'description'	=> array(),
