  ...
  public function get_callbacks(){
   ...
   return array(
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id' => array( 'short_description' => __( '(Integer) The id of the user that has completed the lesson.', 'wp-webhooks' ) ),
			'lesson_id' => array( 'short_description' => __( '(Integer) The id of the lesson that has been completed.', 'wp-webhooks' ) ),
			'lesson' => array( 'short_description' => __( '(Array) Further details about the lesson.', 'wp-webhooks' ) ),
			'lesson_meta' => array( 'short_description' => __( '(Array) The lesson meta data.', 'wp-webhooks' ) ),
			'lesson_user_reading' => array( 'short_description' => __( '(Array) The full lesson reading info.', 'wp-webhooks' ) ),
		);
		...
		return array(
			...
			'name'	   => __( 'Lesson completed', 'wp-webhooks' ),
			'sentence'	   => __( 'a lesson was completed', 'wp-webhooks' ),
			'parameter'	 => $parameter,
			'settings'	 => $settings,
			'returns_code'   => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires after a Tutor LMS lesson was completed.', 'wp-webhooks' ),
			'description'	=> array(),
