  ...
  class WP_Webhooks_Integrations_advanced_custom_fields_Triggers_acf_comment_field_updated {
	...
	public function get_details(){
		...
		$parameter = array(
			...
			'comment_id' => array( 'short_description' => __( '(Integer) The ID of the comment this meta value was updated on.', 'wp-webhooks' ) ),
		...
		$settings = array(
			...
			'data' => array(
				'wpwhpro_advanced_custom_fields_trigger_on_selected_comment_ids' => array(
					...
					'type'		=> 'text',
					'label'	   => __( 'Trigger on selected comment IDs', 'wp-webhooks' ),
					'placeholder' => '',
					'required'	=> false,
					'description' => __( 'Add only the comment IDs you want to fire the trigger on. You can also choose multiple ones by comma-separating them. If none are added, all are triggered.', 'wp-webhooks' )
				),
		...
		return array(
			...
			'name'			  => __( 'ACF comment field updated', 'wp-webhooks' ),
			'sentence'			  => __( 'an ACF comment field was updated', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a comment field was updated within Advanced Custom Fields.', 'wp-webhooks' ),
			'description'	   => array(),
