...
<pre>
{
	"meta_key": "Meta Value"
		...
		$parameter['manage_acf_data']['description'] = ob_get_clean();
			...
			ob_start();
		?>
<?php echo __( "The do_action argument is an advanced webhook for developers. It allows you to fire a custom WordPress hook after the acf_manage_post_meta_data action was fired.", 'wp-webhooks' ); ?>
<br>
	...
	<li>
		...
		$parameter['do_action']['description'] = ob_get_clean();
			...
			return array(
				...
				'name'			  => __( 'Manage ACF post meta', 'wp-webhooks' ),
				'sentence'			  => __( 'add, update, or delete ACF post meta', 'wp-webhooks' ),
				'parameter'		 => $parameter,
				'returns'		   => $returns,
				'returns_code'	  => $returns_code,
				'short_description' => __( 'Add, update, or delete custom post meta data within "Advanced Custom Fields".', 'wp-webhooks' ),
