  ...
  class WP_Webhooks_Integrations_givewp_Triggers_give_donation_cancelled {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Donation cancelled', 'wp-webhooks' ),
			'sentence'			  => __( 'a donation was cancelled', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a donation was cancelled within GiveWP.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'givewp',
			'premium'		   => true,
		);
