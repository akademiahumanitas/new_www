  ...
  class WP_Webhooks_Integrations_givewp_Triggers_give_donation_failed {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Donation failed', 'wp-webhooks' ),
			'sentence'			  => __( 'a donation failed', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a donation failed within GiveWP.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'givewp',
			'premium'		   => true,
		);
