  ...
  class WP_Webhooks_Integrations_givewp_Triggers_give_donation_revoked {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Donation revoked', 'wp-webhooks' ),
			'sentence'			  => __( 'a donation was revoked', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a donation was revoked within GiveWP.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'givewp',
			'premium'		   => true,
		);
