  ...
  class WP_Webhooks_Integrations_givewp_Triggers_give_donation_refunded {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Donation refunded', 'wp-webhooks' ),
			'sentence'			  => __( 'a donation was refunded', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a donation was refunded within GiveWP.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'givewp',
			'premium'		   => true,
		);
