  ...
  class WP_Webhooks_Integrations_givewp_Triggers_give_donation_processed {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Donation processed', 'wp-webhooks' ),
			'sentence'			  => __( 'a donation is processed', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a donation is processed within GiveWP.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'givewp',
			'premium'		   => true,
		);
