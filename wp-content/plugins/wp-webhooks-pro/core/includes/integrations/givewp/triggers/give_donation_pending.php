  ...
  class WP_Webhooks_Integrations_givewp_Triggers_give_donation_pending {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Donation pending', 'wp-webhooks' ),
			'sentence'			  => __( 'a donation is pending', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a donation is pending within GiveWP.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'givewp',
			'premium'		   => true,
		);
