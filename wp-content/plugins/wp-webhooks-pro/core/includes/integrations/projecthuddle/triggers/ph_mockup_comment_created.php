...
if ( ! class_exists( 'WP_Webhooks_Integrations_projecthuddle_Triggers_ph_mockup_comment_created' ) ) :

 /**
  * Load the ph_mockup_comment_created trigger
  *
  * @since 6.0
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_projecthuddle_Triggers_ph_mockup_comment_created {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				'type' => 'action',
				'hook' => 'ph_mockup_publish_comment',
				'callback' => array( $this, 'ph_mockup_comment_created_callback' ),
				'priority' => 20,
				'arguments' => 2,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		return array(
			'trigger'		   => 'ph_mockup_comment_created',
			'name'			  => __( 'Mockup comment created', 'wp-webhooks' ),
			'sentence'			  => __( 'a mockup comment was created', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a mockup comment was created within ProjectHuddle.', 'wp-webhooks' ),
			'description'	   => array(),
	...
	public function ph_mockup_comment_created_callback( $id, $comment ){

		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'ph_mockup_comment_created' );
		...
		do_action( 'wpwhpro/webhooks/trigger_ph_mockup_comment_created', $payload, $response_data_array );
	}
