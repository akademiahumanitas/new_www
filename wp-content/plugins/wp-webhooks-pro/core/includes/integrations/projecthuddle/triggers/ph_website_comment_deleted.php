...
if ( ! class_exists( 'WP_Webhooks_Integrations_projecthuddle_Triggers_ph_website_comment_deleted' ) ) :

 /**
  * Load the ph_website_comment_deleted trigger
  *
  * @since 6.0
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_projecthuddle_Triggers_ph_website_comment_deleted {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				'type' => 'action',
				'hook' => 'ph_website_delete_comment',
				'callback' => array( $this, 'ph_website_comment_deleted_callback' ),
				'priority' => 20,
				'arguments' => 2,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		return array(
			'trigger'		   => 'ph_website_comment_deleted',
			'name'			  => __( 'Website comment deleted', 'wp-webhooks' ),
			'sentence'			  => __( 'a website comment was deleted', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a website comment was deleted within ProjectHuddle.', 'wp-webhooks' ),
			'description'	   => array(),
	...
	public function ph_website_comment_deleted_callback( $id, $comment ){

		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'ph_website_comment_deleted' );
		...
		do_action( 'wpwhpro/webhooks/trigger_ph_website_comment_deleted', $payload, $response_data_array );
	}
