<?php
if ( ! class_exists( 'WP_Webhooks_Integrations_filemaker_Actions_filemaker_duplicate_record' ) ) :

	/**
	 * Load the filemaker_duplicate_record action
	 *
	 * @since 6.1.4
	 * @author Ironikus <info@ironikus.com>
	 */
	class WP_Webhooks_Integrations_filemaker_Actions_filemaker_duplicate_record {
		...
		public function get_details(){
			...
			$parameter = array(
				...
				'layout_name'		=> array(
					...
					'short_description' => __( 'The name of the layout to use as the context for duplicating the record.', 'wp-webhooks' ),
				),
				'record_id'		=> array(
					'required' => true, 
					'label' => __( 'Record ID', 'wp-webhooks' ), 
					'short_description' => __( 'The ID of the record you want to duplicate.', 'wp-webhooks' ),
				),
				'script_name' => array(
			...
			$returns_code = array (
				'success' => true,
				'msg' => 'The record has been successfully duplicated.',
				'data' => 
				array (
				  'response' => 
				  array (
			...
			$description = array(
				'tipps' => array(
					__( 'To learn more about this endpoint, please visit the following URL: ', 'wp-webhooks' ) . '<a title="FileMaker Helpcenter duplicate record" target="_blank" href="https://help.claris.com/en/data-api-guide/content/duplicate-record.html">https://help.claris.com/en/data-api-guide/content/duplicate-record.html</a>',
				),
			);

			return array(
				'action'			=> 'filemaker_duplicate_record', //required
				'name'			   	=> __( 'Duplicate record', 'wp-webhooks' ),
				'sentence'			=> __( 'duplicate a record', 'wp-webhooks' ),
				'parameter'		 	=> $parameter,
				'returns'		   	=> $returns,
				'returns_code'	  	=> $returns_code,
				'short_description' => __( 'Duplicate a record within FileMaker.', 'wp-webhooks' ),
		...
		public function execute( $return_data, $response_body ){
			...
			if( 
				...
				$return_args['msg'] = __( "The record has been successfully duplicated.", 'wp-webhooks' );
				$return_args['data'] = $content;

			} else {
				$return_args['msg'] = __( "An error occured while duplicating the record.", 'wp-webhooks' );
