  ...
  class WP_Webhooks_Integrations_amelia_Triggers_aml_booking_added {
	...
	public function get_details(){
		...
		$parameter = array(
			...
			'bookings' => array( 'short_description' => __( '(Array) Further details about the added booking.', 'wp-webhooks' ) ),
		);
		...
		return array(
			...
			'name'			  => __( 'Booking added', 'wp-webhooks' ),
			'sentence'			  => __( 'a booking was added', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a booking was added within Amelia.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'amelia',
			'premium'		   => false,
		);
