...
if ( ! class_exists( 'WP_Webhooks_Integrations_amelia_Triggers_aml_appointment_canceled' ) ) :

 /**
  * Load the aml_appointment_canceled trigger
  *
  * @since 5.2.4
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_amelia_Triggers_aml_appointment_canceled {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				...
				'callback' => array( $this, 'aml_appointment_canceled_callback' ),
				'priority' => 20,
				'arguments' => 3,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		return array(
			'trigger'		   => 'aml_appointment_canceled',
			'name'			  => __( 'Appointment canceled', 'wp-webhooks' ),
			'sentence'			  => __( 'an appointment was canceled', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as an appointment was canceled within Amelia.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'amelia',
			'premium'		   => true,
		);
	 ...
	 */
	public function aml_appointment_canceled_callback( $reservation, $bookings, $container ){

		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'aml_appointment_canceled' );
		...
		do_action( 'wpwhpro/webhooks/trigger_aml_appointment_canceled', $payload, $response_data_array );
	}
			...
			array (
			  ...
			  array (
				...
				array (
				  ...
				  'cancelUrl' => 'https://demodomain.test/wp-admin/admin-ajax.php?action=wpamelia_api&call=/bookings/cancel/8&token=28ecd41272&type=appointment',
				  'customerPanelUrl' => '',
				  'infoArray' => NULL,
				),
			  ),
			  ...
			  'zoomMeeting' => NULL,
			  'lessonSpace' => NULL,
			  'bookingStart' => '2022-07-29 10:30:00',
			  'bookingEnd' => '2022-07-29 11:30:00',
			  'type' => 'appointment',
			  'isRescheduled' => NULL,
			),
			'bookings' => 
