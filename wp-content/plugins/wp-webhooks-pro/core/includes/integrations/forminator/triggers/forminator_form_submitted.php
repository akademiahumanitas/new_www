   ...
   */
	...
	public function get_details(){
		...
		$parameter = array(
			...
			'response' => array( 'short_description' => __( '(Array) Further details about the response data that was sent back to the form caller.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'short_description' => __( 'This webhook fires as soon as a form is submitted within Forminator.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'forminator',
			'premium'		   => false,
		);
