  ...
  */
  class WP_Webhooks_Integrations_bbpress_Triggers_bbp_topic_favored {
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id' => array( 'short_description' => __( '(Integer) The ID of the user who favored the topic.', 'wp-webhooks' ) ),
		...
		return array(
			...
			'name'			  => __( 'Topic favored', 'wp-webhooks' ),
			'sentence'			  => __( 'a topic was favored', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a topic was favored within bbPress.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'bbpress',
			'premium'		   => false,
		);
