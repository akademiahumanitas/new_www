  ...
  */
  class WP_Webhooks_Integrations_bbpress_Triggers_bbp_topic_reply_created {
	...
	public function get_details(){
		...
		$parameter = array(
			'reply_id' => array( 'short_description' => __( '(Integer) The Id of the newly created reply.', 'wp-webhooks' ) ),
			'topic_id' => array( 'short_description' => __( '(Integer) The topic ID related to the reply.', 'wp-webhooks' ) ),
			'forum_id' => array( 'short_description' => __( '(Integer) The ID of the forum the reply was created in.', 'wp-webhooks' ) ),
			'reply_author' => array( 'short_description' => __( '(Integer) The ID of the author of the reply.', 'wp-webhooks' ) ),
			'reply_to' => array( 'short_description' => __( '(Integer) The ID of the reply it is related.', 'wp-webhooks' ) ),
			'reply_data' => array( 'short_description' => __( '(Array) Further data about the given reply.', 'wp-webhooks' ) ),
		);
		...
		return array(
			...
			'name'			  => __( 'Topic reply created', 'wp-webhooks' ),
			'sentence'			  => __( 'a topic reply was created', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a topic reply was created within bbPress.', 'wp-webhooks' ),
			'description'	   => array(),
			'integration'	   => 'bbpress',
			'premium'		   => true,
		);
