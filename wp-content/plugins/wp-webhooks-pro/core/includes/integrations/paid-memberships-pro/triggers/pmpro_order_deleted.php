  ...
  */
   ...
   */
    ...
    public function get_details(){
        ...
        $parameter = array(
            'user_id' => array( 'short_description' => __( '(Integer) The ID of the user of which the order was deleted.', 'wp-webhooks' ) ),
            'membership_id' => array( 'short_description' => __( '(Integer) The ID of the membership level.', 'wp-webhooks' ) ),
            'order' => array( 'short_description' => __( '(Array) The full order data of the deleted order.', 'wp-webhooks' ) ),
        );
        ...
        return array(
            ...
            'name'              => __( 'Order deleted', 'wp-webhooks' ),
            'sentence'              => __( 'an order was deleted', 'wp-webhooks' ),
            'parameter'         => $parameter,
            'settings'          => $settings,
            'returns_code'      => $this->get_demo( array() ),
            'short_description' => __( 'This webhook fires as soon as an order was deleted within Paid Memberships Pro.', 'wp-webhooks' ),
            'description'       => array(),
            'integration'       => 'paid-memberships-pro',
            'premium'           => true,
        );
