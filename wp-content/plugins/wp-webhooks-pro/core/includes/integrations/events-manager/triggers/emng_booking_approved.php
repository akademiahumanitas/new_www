  ...
  class WP_Webhooks_Integrations_events_manager_Triggers_emng_booking_approved {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Booking approved', 'wp-webhooks' ),
			'sentence'			  => __( 'a booking was approved', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a booking was approved within Events Manager.', 'wp-webhooks' ),
			'description'	   => array(),
