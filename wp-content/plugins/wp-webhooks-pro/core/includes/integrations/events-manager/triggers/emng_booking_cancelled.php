  ...
  class WP_Webhooks_Integrations_events_manager_Triggers_emng_booking_cancelled {
	...
	public function get_details(){
		...
		return array(
			...
			'name'			  => __( 'Booking cancelled', 'wp-webhooks' ),
			'sentence'			  => __( 'a booking was cancelled', 'wp-webhooks' ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => __( 'This webhook fires as soon as a booking was cancelled within Events Manager.', 'wp-webhooks' ),
			'description'	   => array(),
