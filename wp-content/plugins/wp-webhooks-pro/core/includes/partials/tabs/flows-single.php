...
<div class="wpwh-flows-wrapper">
	<div class="wpwh-container">
		<div class="wpwh-title-area mb-4">
			<h2><?php echo __( 'Add new Webhook', 'wp-webhooks' ); ?></h2>
		</div>
				...
				<div class="wpwh-flows__content-sidebar">
					<div class="wpwh-flows__content">
						...
						<div class="wpwh-form-field">
							<label for="wpwhAddNew-name" class="wpwh-form-label"><?php echo __( 'Enter Title Here', 'wp-webhooks' ); ?></label>
									...
									<div class="wpwh-flows-step__header">
										...
										<div class="wpwh-flows-step__header-text">
											...
											<p class="wpwh-flows-step__header-text">
												<span class="wpwh-text-small"><?php echo __( 'Trigger', 'wp-webhooks' ); ?></span> <a href="#" data-toggle="modal" data-target="#chooseIntegrationTriggerModal"><?php echo __( 'Choose integration', 'wp-webhooks' ); ?></a>
											</p>
                      ...
                      <?php /* START: LINKS */ ?>
                        ...
                        <div class="text-right mt-3">
                          <button type="button" class="wpwh-btn wpwh-btn--secondary wpwh-btn--sm wpwh-flows-links__add">
                            <span><?php echo __( 'Add link', 'wp-webhooks' ); ?></span>
                          </button>
                        </div>
											</div>
                      <?php /* END: LINKS */ ?>
						...
						<button type="button" class="wpwh-btn wpwh-btn--secondary wpwh-btn--lg wpwh-btn--block wpwh-flows-select-trigger mt-5" data-toggle="modal" data-target="#chooseIntegrationTriggerModal">
							<span><?php echo __( 'Select a trigger', 'wp-webhooks' ); ?></span>
						</button>
						...
						<button class="wpwh-btn wpwh-btn--secondary wpwh-btn--lg wpwh-btn--block wpwh-flows-select-trigger" disabled><span><?php echo __( 'Add an action', 'wp-webhooks' ); ?></span></button>
						...
						<div class="wpwh-flows-widget">
							<div class="wpwh-publish-box">
								...
								<p class="d-flex align-items-center">
									...
									<span class="wpwh-publish-box__title"><?php echo __( 'Status:', 'wp-webhooks' ); ?></span>
									<select name="status" id="wpwhFlowsAddNew-status" class="wpwh-form-input wpwh-form-input--sm w-auto">
										<option value="inactive"><?php echo __( 'Inactive', 'wp-webhooks' ); ?></option>
										<option value="active"><?php echo __( 'Active', 'wp-webhooks' ); ?></option>
									</select>
								</p>
								...
								<p class="d-flex align-items-center">
									...
									<span class="wpwh-publish-box__title"><?php echo __( 'Created on:', 'wp-webhooks' ); ?></span>
									<strong><?php echo date( __( 'F j, Y', 'wp-webhooks' ), strtotime( 'July 14, 2021' ) ); ?></strong>
								</p>

								<button type="submit" class="wpwh-btn wpwh-btn--secondary wpwh-btn--sm"><span>Save<?php echo __( '', 'wpwhpro-page-flows-single' ); ?></span></button>

							</div>
						</div>

						<div class="wpwh-flows-widget">
							<h4 class="wpwh-flows-widget__title"><?php echo __( 'Selected Steps:', 'wp-webhooks' ); ?></h4>
							<div class="wpwh-selected-steps">

								<p class="m-0"><?php echo __( 'No selected steps', 'wp-webhooks' ); ?></p>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title"><?php echo __( 'Choose Integration', 'wp-webhooks' ); ?></h3>
						...
						<a href="#" class="wpwh-flows-integration">
							<div class="wpwh-flows-integration__inner">
								<div class="wpwh-flows-integration__icon">
									<img src="<?php echo $integration_image; ?>" alt="<?php echo sprintf( __( 'The logo of the %1$s integration.', 'wp-webhooks' ), $integration_name ); ?>">
								</div>
