    ...
    <div class="wpwh-container">
        <form id="wpwh-main-settings-form" method="post" action="">
            ...
            <div class="wpwh-title-area mb-4">
                <h2><?php echo __( 'Whitelabel settings', 'wp-webhooks' ); ?></h2>
                <p class="wpwh-text-small">
                    <?php echo sprintf(__( 'This is the hidden page for your whitelabel settings. Here, you will be able to configure all settings related to create a whitelabeled version of %1$s. To learn more about it, you can also check out our <a href="%2$s" target="_blank" >documentation</a>.', 'wp-webhooks' ), 'WP Webhooks Pro', 'https://wp-webhooks.com/docs/knowledge-base/whitelabel-wp-webhooks-pro/'); ?>
                </p>
            </div>
    ...
    <div class="wpwh-container">
        <div class="wpwh-settings p-4">
            <div class="wpwh-title-area">
                <h2><?php echo __( 'Activate License', 'wp-webhooks' ); ?></h2>
                <p class="wpwh-text-small mb-3">
                    <?php echo sprintf(__( 'To use the whitelabel feature, you must have an active WP Webhooks Pro Unlimited subscription with an active license. Please activate your license first or check out our comparison table to <a class="text-secondary" href="%2$s" target="_blank" >learn more</a>.', 'wp-webhooks' ), 'WP Webhooks Pro', 'https://wp-webhooks.com/?utm_source=wp-webhooks-pro&utm_medium=whitelabel-feature&utm_campaign=WP%20Webhooks%20Pro'); ?>
                </p>
                <a href="<?php echo $license_url; ?>" class="wpwh-btn wpwh-btn--secondary" target="_blank" rel="noopener noreferrer"><?php echo __( 'Activate License', 'wp-webhooks' ); ?></a>
            </div>
        </div>
    </div>
<?php endif; ?>