		...
		switch( $previous_step ){
			case 'settings':
				...
				if( isset( $_POST['wpwh_wizard_log_autoclean'] ) && ! empty( $_POST['wpwh_wizard_log_autoclean'] ) ){
					WPWHPRO()->settings->save_settings( array( 'wpwhpro_autoclean_logs' => sanitize_title( $_POST['wpwh_wizard_log_autoclean'] ) ), false );
				}
